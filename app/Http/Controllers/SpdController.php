...
class SpdController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $spd = Spd::create([
            ...
            'uang_transport' => $request->uangTransport,
            'uang_hotel' => $request->uangHotel,
    ...
    public function show($id)
    {
        ...
        $mapped = [
            ...
            'status' => $spd->status,
            'anggaran' => $spd->anggaran,
            'uang_harian' => $spd->uang_harian,
            'uang_transport' => $spd->uang_transport,
            'uang_hotel' => $spd->uang_hotel,
            'pejabatPemberi' => $spd->pejabat_pemberi,
            'pangkat' => $spd->pangkat,
            'jabatan' => $spd->jabatan,
            'angkutan' => $spd->angkutan,
    ...
    public function update(Request $request, $id)
    {
        ...
        $spd->update([
            ...
            'uang_harian' => $request->uangHarian ?? $spd->uang_harian,
            'uang_transport' => $request->uangTransport ?? $spd->uang_transport,
            'uang_hotel' => $request->uangHotel ?? $spd->uang_hotel,
