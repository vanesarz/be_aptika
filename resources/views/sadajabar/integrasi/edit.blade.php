{{-- ============================================================ --}}
{{-- FILE: resources/views/sadajabar/integrasi/edit.blade.php   --}}
{{-- ============================================================ --}}
@extends('layouts.app')

@section('title', 'Edit Integrasi — SaDAJabar')

@section('content')
<div class="page-header">
    <div>
        <h1>Edit Data Integrasi</h1>
...
<div class="card">
    <form action="{{ route('sadajabar.integrasi.update', $item->id) }}" method="POST">
        @csrf @method('PUT')
        ...
        <div class="form-group">
            ...
            <select id="sadajabar_institution_categories_id"
                ...
                @foreach($categories as $cat)
                    <option value="{{ $cat->id }}"
                        {{ old('sadajabar_institution_categories_id', $item->sadajabar_institution_categories_id) == $cat->id ? 'selected' : '' }}>
                        {{ $cat->name }}
                    </option>
                @endforeach
            </select>
